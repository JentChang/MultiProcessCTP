...
private:
    ...
    std::shared_ptr<IPageProvider> pageProvider;
...
public:
    ...
    static std::shared_ptr<Journal> create(const string& dir, const string& jname, int serviceIdx, std::shared_ptr<IPageProvider> provider);
