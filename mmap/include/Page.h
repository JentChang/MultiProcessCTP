...
public:
	...
	inline void* locateReadableFrame()
	{
...
public:
    ...
    static  std::shared_ptr<Page> load(const string& dir, const string& jname, short pageNum, bool isWriting, bool quickMode);
